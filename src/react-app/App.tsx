...
const COURTS: Court[] = [
  ...
  { id: "islington_tennis_centre_outdoors", label: "Islington Tennis Centre (Outdoors)", indoors: false, floodlights: true, travelDistance: 60, travelDifficulty: "Easy", travelPrice: 3.6, free: false, courtQuality: "TBC", towerHamlets: false },
  ...
  { id: "lee_valley_hockey_and_tennis_centre_indoors", label: "Lee Valley Hockey and Tennis Centre (Indoors)", indoors: true, floodlights: true, travelDistance: 50, travelDifficulty: "Easy", travelPrice: 4.05, free: false, courtQuality: "Great", towerHamlets: false },
  { id: "lee_valley_hockey_and_tennis_centre_outdoors", label: "Lee Valley Hockey and Tennis Centre (Outdoors)", indoors: false, floodlights: true, travelDistance: 50, travelDifficulty: "Easy", travelPrice: 4.05, free: false, courtQuality: "Great", towerHamlets: false },
