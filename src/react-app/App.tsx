...
const COURTS: Court[] = [
  ...
  { id: "queen's_park", label: "Queen's Park", indoors: false, floodlights: false, travelDistance: 60, travelDifficulty: "Easy", travelPrice: 3.6, free: false, courtQuality: "TBC", towerHamlets: false },
