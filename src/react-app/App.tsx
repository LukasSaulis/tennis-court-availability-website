...
const COURTS: Court[] = [
  ...
  { id: "bethnal_green_gardens", label: "Bethnal Green Gardens", indoor: false, floodlights: true, distanceMins: 35, distanceLabel: "40 min", difficulty: "Easy", travelPrice: 1.75, towerHamlets: true },
  ...
  { id: "poplar_recreation_ground", label: "Poplar Recreation Ground", indoor: false, floodlights: false, distanceMins: 17, distanceLabel: "20 min", difficulty: "Easy", travelPrice: 1.75, towerHamlets: true },
  ...
  { id: "ropemakers_fields", label: "Ropemakers Fields", indoor: false, floodlights: false, distanceMins: 19, distanceLabel: "20 min", difficulty: "Easy", travelPrice: 2.1, towerHamlets: true },
  ...
  { id: "victoria_park", label: "Victoria Park", indoor: false, floodlights: false, distanceMins: 48, distanceLabel: "50 min", difficulty: "Hard", travelPrice: 1.75, towerHamlets: true },
  { id: "wapping_gardens", label: "Wapping Gardens", indoor: false, floodlights: false, distanceMins: 31, distanceLabel: "30 min", difficulty: "Easy", travelPrice: 2.2, towerHamlets: true },
